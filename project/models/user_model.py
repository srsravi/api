...
class CustomerModal(BaseModel):
    ...
    pan_card_number = Column(String(55), default="")
    aadhaar_card_number = Column(String(55), default="")
    nominee = Column(String(100), default="")
    relation_with_nominee = Column(String(200), default="")    
    aadhaar_card = Column(Text(), default="")
    canceled_cheque = Column(Text(), default="")
